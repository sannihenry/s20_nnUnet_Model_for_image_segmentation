...
parser.add_argument("--data", type=str, default="/project/6055667/spark20/BraTS/BraTS2023_SSA/BraTS2023_SSA", help="Path to data directory")
parser.add_argument("--results", type=str, default="/project/6055667/spark20/BraTS/BraTS2023_SSA/BraTS2023_SSA", help="Path for saving results directory")
parser.add_argument(
    "--exec_mode",
    type=str,
    default="training",
...
parser.add_argument("--task", type=str, default=12, help="Number of task to be run. MSD uses numbers 01-10")
