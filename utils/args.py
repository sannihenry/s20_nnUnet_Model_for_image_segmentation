...
def get_main_args(strings=None):
    ...
    arg("--data", type=str, default="/project/6055667/spark20/BraTS/BraTS2023_SSA/BraTS2023_SSA", help="Path to data directory")
    arg("--results", type=str, default="/project/6055667/spark20/BraTS/BraTS2023_SSA/BraTS2023_SSA/results", help="Path to results directory")
    ...
    arg("--ckpt_path", type=str, default="/project/6055667/spark20/BraTS/BraTS2023_SSA/BraTS2023_SSA/results/checkpoints", help="Path for loading checkpoint")
    arg("--ckpt_store_dir", type=str, default="/project/6055667/spark20/BraTS/BraTS2023_SSA/BraTS2023_SSA/results", help="Path for saving checkpoint")
