...
def prepare_dataset(data):
    ...
    prepare_dirs(data)
    prepare_dataset_json(data)
    end = time.time()
    print(f"Preparing time: {(end - start):.2f}")

prepare_dataset("/project/6055667/spark20/BraTS/BraTS2021/BraTS_2021_Train", True)
prepare_dataset("/project/6055667/spark20/BraTS/BraTS2021/BraTS_2021_Val")
print("Finished!")