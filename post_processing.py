...
def prepare_preditions(e):
    ...
    img = nib.load(f"/project/6055667/spark20/BraTS/BraTS2021/BraTS_2021_Val/images/{fname}.nii.gz")
    nib.save(
        nib.Nifti1Image(p, img.affine, header=img.header),
        os.path.join("/project/6055667/spark20/BraTS/BraTS2021/results/final_preds", fname + ".nii.gz"),
    )

os.makedirs("/project/6055667/spark20/BraTS/BraTS2021/results/final_preds")
preds = sorted(glob(f"/project/6055667/spark20/BraTS/BraTS2021/results/predictions_epoch=24-dice=86_42_task=01_fold=0_tta*"))
